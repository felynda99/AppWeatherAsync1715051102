...
async getWeather() {
    ...
    try {
        ...
        let response = await fetch(
            'http://api.openweathermap.org/data/2.5/weather?q=' + this.state.city + '&appid=ad1f506b88c1a6ed9a6a2b9e0882b359&units=metric'
        );
      ...
      <View style={styles.containerMain}>
          ...
          <View style={styles.box3}>
            <View style={styles.box4}>
                ...
                <View style={styles.textInput}>
                  <View>
                       <Image source={require("./cuaca.png")} style={styles.image} />  
                  </View>
                ...
                <View style={styles.textInput}>
                  <View>
                       <Image source={require("./Pressure.png")} style={styles.image} />  
                  </View>
              ...
              <View style={styles.box5}>
                <View style={styles.textInput}>
                  <View>
                      <Image source={require("./sea.png")} style={styles.image} />
                  </View>
                ...
                <View style={styles.textInput}>
                  <View>
                       <Image source={require("./desc.png")} style={styles.image} />  
                  </View>
                ...
                <View style={styles.textInput}>
                  <View>
                       <Image source={require("./humidity.png")} style={styles.image} />  
                   </View>
